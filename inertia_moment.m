...
wing_para=wing_shape_fruitfly_sixteen_good(R_wing,C_aver,xr0,C_maxyaxis);
...
z_com_zaxis=abs(abs(ZC_tran)+z_maxlead-z_maxlead_xaxis);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% 惯性矩 (WCS)   g.mm^2
...
I_moment=[Ix_inertia,Iz_inertia];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
