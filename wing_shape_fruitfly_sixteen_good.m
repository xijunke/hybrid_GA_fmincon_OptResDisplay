% function wing_para_output=wing_shape_fruitfly_sixteen_good(R_wing,C_aver,xr0,C_maxyaxis)  % 输入变量是R和C_ave, xr0和C_maxyaxis
% function wing_para_output=wing_shape_fruitfly_sixteen_good()  % 输入变量是R_wingeff和C_avereff, xr和C_maxy
...
% x =[3.1267,1.1578,0.7896,0.1624];          % 20150423_WingM4_4_1-结果非常不错
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 这一小段是多余的
% xr1=0.3289;                           % x-root offset  \mm
% xr_nd1=xr1/R_wing;               % x-root offset  无量纲展向偏置距离
...
P_coefflead=polyfit(r_x,f_x_lead2,6);  % 产生多项式系数
...
P_coefftrail=polyfit(r_x,f_x_trail2,6);  % 产生多项式系数
% yr_trailnd2= -9.314e-010*r_x.^6+4.099e-007*r_x.^5-6.329e-005*r_x.^4+0.004316*r_x.^3 -0.1158*r_x.^2+0.02573*r_x+0.034;
% (3)  无量纲弦长分布函数
Crnd=f_x_lead2-f_x_trail2;
P_coeffCr=polyfit(r_x,Crnd,6);  % 产生多项式系数  % Cr_nd2=polyval(Coeff,r_nd1);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% syms r_x   % 无量纲弦长分布为6阶多项式——转换必须有这条指令——产生表达式
% yr_leadnd2=vpa(poly2sym(P_coefflead,r_x),6);
% yr_trailnd2=vpa(poly2sym(P_coefftrail,r_x),6);
% Crnd=vpa(poly2sym(P_coeffCr,r_x),6); 
% % yr_leadnd2 =-0.501496*r_x^6+4.5192*r_x^5-16.2456*r_x^4+29.3835*r_x^3-27.8303*r_x^2+13.2218*r_x-2.79035;
% % yr_trailnd2 =-0.202446*r_x^6+2.44506*r_x^5-10.95*r_x^4+23.2936*r_x^3-23.7779*r_x^2+9.59747*r_x-1.8472;
% % Crnd =-0.299049*r_x^6+2.07414*r_x^5-5.29561*r_x^4+6.0899*r_x^3-4.05242*r_x^2+3.62429*r_x-0.943148;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
yr_leadnd2=polyval(P_coefflead,r_x);
yr_trailnd2=polyval(P_coefftrail,r_x);
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
figure(6)   % 绘制拟合好的前后缘 & 翅膀放大之后的压心位置
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
yr_leadnd2=vectorize(inline('-0.501496*r_x^6+4.5192*r_x^5-16.2456*r_x^4+29.3835*r_x^3-27.8303*r_x^2+13.2218*r_x-2.79035','r_x'));
yr_trailnd2= vectorize(inline('-0.202446*r_x^6+2.44506*r_x^5-10.95*r_x^4+23.2936*r_x^3-23.7779*r_x^2+9.59747*r_x-1.8472','r_x'));
Area=quadl(yr_leadnd2,0.3289,100.3289)-quadl(yr_trailnd2,0.3289,100.3289);
integrand_xc=vectorize(inline('r_x.*((-0.501496*r_x^6+4.5192*r_x^5-16.2456*r_x^4+29.3835*r_x^3-27.8303*r_x^2+13.2218*r_x-2.79035)-(-0.202446*r_x^6+2.44506*r_x^5-10.95*r_x^4+23.2936*r_x^3-23.7779*r_x^2+9.59747*r_x-1.8472))','r_x')); %数值函数
integrand_zc=vectorize(inline('(-0.501496*r_x^6+4.5192*r_x^5-16.2456*r_x^4+29.3835*r_x^3-27.8303*r_x^2+13.2218*r_x-2.79035).^2-(-0.202446*r_x^6+2.44506*r_x^5-10.95*r_x^4+23.2936*r_x^3-23.7779*r_x^2+9.59747*r_x-1.8472).^2','r_x')); %数值函数
